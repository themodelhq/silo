...
const CACHE_VERSION = "payenvelope-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./offline.html",
...
self.addEventListener("sync", (event) => {
  if (event.tag === "payenvelope-sync-queue") {
    event.waitUntil(
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || "PayEnvelope", {
      body: payload.body || "",
