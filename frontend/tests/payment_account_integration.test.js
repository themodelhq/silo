...
function makeSandbox() {
  ...
  vm.runInContext(fs.readFileSync(path.join(__dirname, "..", "js", "config.js"), "utf8"), sandbox, { filename: "config.js" });
  sandbox.window.SILO_CONFIG.API_BASE_URL = API_BASE_URL; // point the real config-loading mechanism at the local test server
  return sandbox;
}
