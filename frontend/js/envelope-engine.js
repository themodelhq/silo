/**
 * Silo Envelope Engine (client-side)
 * ===========================================
...
window.SiloEngine = { EnvelopeEngine, AllocationType, DEFAULT_ALLOCATION_RULES, DEFAULT_ENVELOPE_CATALOG, validateRuleSet, uuid };
