...
- Live Paystack credentials — the virtual-account and webhook code is real
  ...
  1. a real `PAYSTACK_SECRET_KEY` (without one, `POST /payments/accounts`
     returns a clear `502` rather than failing silently);
  ...
  4. if your Paystack business category is **Betting**, **Financial
  ...
  5. for **outbound transfers** specifically: your Paystack account needs an
