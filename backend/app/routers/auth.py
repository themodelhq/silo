...
def update_me(
    ...
    """Update the current user's profile — most notably `phone`, which
    Paystack requires before POST /payments/accounts can request a dedicated
    virtual account (it can also be supplied directly on that call instead)."""
